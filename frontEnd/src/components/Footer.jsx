...
import { FaBuilding, FaFacebook, FaTwitter, FaInstagram, FaLinkedin } from 'react-icons/fa';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/properties/create" className="text-gray-400 hover:text-white transition-colors">
                  List Property
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <span className="block">Email: info@estatehub.com</span>
              </li>
            </ul>
          </div>
        </div>
